...
/**
   Karel J Robot Chapter 7 Homework, Problems 1-3.
   Tests three recursive classes Karpeter, WestWallBeeperGetter, and
   BeeperMover.
...
public class RecursionWorld implements Directions
{
    ...
    public static void main( String args[] )
    {
        ...
        WestWallBeeperGetter karel2 =
            new WestWallBeeperGetter( 8, 10, East, 0, Color.red );
